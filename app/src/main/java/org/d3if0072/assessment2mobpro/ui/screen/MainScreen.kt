...
import org.d3if0072.assessment2mobpro.util.SettingsDataStore
                    ...
                    IconButton(onClick = { CoroutineScope(Dispatchers.IO).launch {
                        ...
                        Icon(
                            painter = painterResource(
                                if (showList) R.drawable.baseline_grid_on_24
...
@Composable
fun ListItem(laptop: Laptop, onClick: () -> Unit ){
    Column(
        modifier = Modifier
            .fillMaxWidth()
            .clickable { onClick() }
...
@Composable
fun GridItem(laptop: Laptop,onClick: () -> Unit){
    Card (
        modifier = Modifier
            .fillMaxWidth()
            .clickable { onClick() },
